...
<template>
  <footer
      class="sticky
      short:static
      left-0 -mx-1 bottom-0 z-20 bg-error
      h-20 lg:h-32 3xl:h-64 short:h-20 flex
      items-center justify-center overflow-hidden">
    <div class="text-error-content p-2 font-semibold text-lg xs:text-xs md:text-3xl lg:text-4xl short:text-base flex-1 max-w-lg">
