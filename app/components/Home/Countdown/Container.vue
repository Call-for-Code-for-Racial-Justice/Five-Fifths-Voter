...
<template>
  <footer
      class="sticky left-0 -mx-1 bottom-0 z-20 h-20 [@media(max-height:640px)]:h-16 bg-error md:h-28 xl:h-32 3xl:h-64 p-2 [@media(max-height:640px)]:p-1 flex items-center justify-center overflow-hidden">
    <div class="text-error-content p-2 [@media(max-height:640px)]:p-1 font-semibold text-lg [@media(max-height:640px)]:text-base [@media(max-width:320px)]:text-xs md:text-3xl lg:text-4xl flex-1 max-w-lg">
