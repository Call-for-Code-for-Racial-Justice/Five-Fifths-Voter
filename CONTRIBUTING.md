...
[Slack in the #racial-justice-five-fifths-voter channel](https://callforcode.slack.com/archives/C01CDLTU015) in the [Call for Code Slack workspace](https://callforcode.org/slack). Minor issues can simply be addressed by sending by a pull request.
