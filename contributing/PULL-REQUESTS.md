...
- [Reviewing Pull Requests](#reviewing-pull-requests)
  ...
  - [Accept that there are different opinions about what belongs in Five Fifths Voter](#accept-that-there-are-different-opinions-about-what-belongs-in-five-fifths-voter)
...
More details to come on Call for Code for Racial Justice Five Fifths Voter dependencies. In case of doubt, open an issue in the
[issue tracker](https://github.com/Call-for-Code-for-Racial-Justice/Five-Fifths-Voter/issues/) or engage on the
...
Fork the project [on GitHub](https://github.com/Call-for-Code-for-Racial-Justice/Five-Fifths-Voter) and clone your fork
locally.

```text
$ git clone git@github.com:username/Five-Fifths-Voter.git
$ cd Five-Fifths-Voter
$ git remote add upstream https://github.com/Call-for-Code-for-Racial-Justice/Five-Fifths-Voter.git
$ git fetch upstream
```
...
Five Fifths Voter does not yet have a style guide.
...
Fixes: https://github.com/Call-for-Code-for-Racial-Justice/Five-Fifths-Voter/issues/343
Refs: http://eslint.org/docs/rules/space-in-parens.html
```

If you are new to contributing to Call for Code for Racial Justice Five Fifths Voter, please try to do your best at
...
at least two Five Fifths Voter Collaborators (one Collaborator approval is enough if the
...
All Five Fifths Voter contributors who choose to review and provide feedback on Pull
...
1. Does this change make sense for Five Fifths Voter?
2. Does this change make Five Fifths Voter better, even if only incrementally?
...
Five Fifths Voter Collaborator landing the Pull Request but they can also be an
...
a particular change that makes Five Fifths Voter better, but the individual might just
not want to have anything to do with Five Fifths Voter ever again. The goal is not just
having good code.
...
Any Five Fifths Voter core Collaborator (any GitHub user with commit rights in the
`Call-for-Code-for-Racial-Justice/Five-Fifths-Voter` repository) is authorized to approve any other contributor's
...
to block the PR from landing. When doing so, explain _why_ you believe the
Pull Request should not land along with an explanation of what may be an
acceptable alternative course, if any.

### Accept that there are different opinions about what belongs in Five Fifths Voter

Opinions on this vary, even among the members of the Technical Steering
Committee.

One general rule of thumb is that if Five Fifths Voter itself needs it (due to historic
or functional reasons), then it belongs in Five Fifths Voter.
...
make Five Fifths Voter better. These may or may not make sense to add, but as with all
...
Five Fifths Voter has always optimized for speed of execution. If a particular change
can be shown to make some part of Five Fifths Voter faster, it's quite likely to be
...
That said, performance is not the only factor to consider. Five Fifths Voter also
...
to make sure that it works on the platforms that Five Fifths Voter
...
[Code of Conduct]: https://github.com/Call-for-Code-for-Racial-Justice/Five-Fifths-Voter/blob/master/CONTRIBUTING.md
